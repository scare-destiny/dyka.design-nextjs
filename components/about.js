...
const About = () => (
	...
	>
		...
		<Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
			<chakra.p fontFamily={'Inter'} fontWeight={'medium'} fontSize={'1rem'} p={5}>
				<span className='about-span'>
					{' '}
					Hi, my name is Anastasiia, and welcome to my website!{' '}
				</span>{' '}
				My passion for design and understanding clients&apos; needs is what I have
				lived and breathed the last decade. For me, talent results from discipline,
				so I push myself every day to improve.
			</chakra.p>
			<chakra.p fontFamily={'Inter'} fontWeight={'medium'} fontSize={'1rem'} p={5}>
				My career started at a design bureau while I studied at Berlin International
				University. Over the years, I&apos;ve successfully finished dozens of
				projects and received positive feedback.
			</chakra.p>
			<chakra.p fontFamily={'Inter'} fontWeight={'medium'} fontSize={'1rem'} p={5}>
